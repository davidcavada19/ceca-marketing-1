...
export default function TopBar({ t, lang, setLang, online }: TopBarProps) {
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 60, background: 'var(--bg)', borderBottom: '1px solid var(--line)' }}>
      <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 20px', borderTop: '1px solid var(--line)' }}>
  ...
  <a href="mailto:davidcavada19@gmail.com"
    ...
    davidcavada19@gmail.com
          ...
          <a href="/portfolio" className="nav-portfolio" style={{ fontFamily: 'var(--mono)', fontSize: 11, color: 'var(--fg)', letterSpacing: '.08em', textTransform: 'uppercase', opacity: 0.75, fontWeight: 600 }}>
  Portfolio
</a>
