      ...
      <section style={{ padding: '112px 28px', borderBottom: '1px solid var(--line)', background: 'var(--accent)', color: 'var(--accent-contrast)' }}>
        <div className="free-section-grid" style={{ maxWidth: 1320, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 40, alignItems: 'center' }}>
          <div className="free-section-content" style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <h2 className="free-title" style={{ margin: 0, fontFamily: 'var(--display)', fontWeight: 900, fontSize: 'clamp(40px, 6vw, 96px)', lineHeight: 0.94, letterSpacing: '-.03em' }}>
            ...
            <div style={{ marginTop: 36 }}>
              <CtaButton lang={lang} onClick={() => smoothScrollTo('contact')}
                style={{ background: '#ffffff', color: '#0A0F1E', border: '1px solid #ffffff', padding: '18px 24px' }}>
                {t.free_cta}
              </CtaButton>
            </div>
            ...
            <div className="contact-row" style={{ display: 'flex', alignItems: 'center', gap: 28, marginTop: 24, paddingTop: 16, borderTop: '1px solid rgba(255,255,255,0.3)' }}>
