  ...
  return (
    <footer style={{ padding: '60px 28px 28px', borderTop: '1px solid var(--line)' }}>
      <div style={{ maxWidth: 1520, margin: '0 auto' }}>
        ...
        {/* Top row */}
        <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: '1.5fr 1fr 1fr', justifyItems: 'start', alignItems: 'start', gap: 60, paddingBottom: 40, borderBottom: '1px solid var(--line)' }}>
          ...
          <div>
            ...
            <p className="footer-tagline" style={{ fontFamily: 'var(--mono)', fontSize: 12, color: 'var(--muted)', letterSpacing: '.04em', marginBottom: 24, lineHeight: 1.6 }}>
              // {t.footer_tagline}
            </p>

            <div className="footer-contact-follow">

              <div className="footer-contact-mobile-only" style={{ display: 'none', fontFamily: 'var(--mono)', fontSize: 12, color: 'var(--muted)', letterSpacing: '.04em' }}>
                ...
                <div className="footer-location-mobile" style={{ marginTop: 4 }}>Houston, TX · UTC-5 / CST</div>
              </div>

              <div className="footer-follow-mobile-only" style={{ display: 'none', fontFamily: 'var(--mono)', fontSize: 12, color: 'var(--muted)', letterSpacing: '.04em' }}>
                ...
                <a href="https://www.instagram.com/ceca_marketing" target="_blank" rel="noopener noreferrer"
                  style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'var(--muted)', marginBottom: 10, textDecoration: 'none' }}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="url(#ig-grad-f-m)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <defs>
                      <linearGradient id="ig-grad-f-m" x1="0%" y1="100%" x2="100%" y2="0%">
                ...
                <div className="footer-status-mobile" style={{ paddingTop: 16, borderTop: '1px solid var(--line)' }}></div>
              </div>

            </div>

            <div className="footer-nav-links" style={{ display: 'flex', flexWrap: 'wrap', gap: '8px 20px', marginTop: 24 }}>
            {navLinks.map((link) => (
          ...
          {/* Col 2 — Contact (desktop) */}
          <div className="footer-contact-desktop" style={{ fontFamily: 'var(--mono)', fontSize: 12, color: 'var(--muted)', letterSpacing: '.04em' }}>
            <div style={{ color: 'var(--fg)', marginBottom: 16, letterSpacing: '.08em', fontSize: 11, textTransform: 'uppercase' }}>Contact</div>
            <a href="https://wa.me/18329082728" target="_blank" rel="noopener noreferrer"
              style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'var(--muted)', marginBottom: 10, textDecoration: 'none' }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="#25D366">
          ...
          {/* Col 3 — Follow + Status (desktop) */}
          <div className="footer-follow-desktop" style={{ fontFamily: 'var(--mono)', fontSize: 12, color: 'var(--muted)', letterSpacing: '.04em' }}>
            <div style={{ color: 'var(--fg)', marginBottom: 16, letterSpacing: '.08em', fontSize: 11, textTransform: 'uppercase' }}>Follow</div>
            <a href="https://www.instagram.com/ceca_marketing" target="_blank" rel="noopener noreferrer"
              style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'var(--muted)', marginBottom: 10, textDecoration: 'none' }}>
