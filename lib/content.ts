...
export const CECA_CONTENT: Record<string, SiteContent> = {
  ...
  es: {
    ...
    services_title: ['Cuatro servicios.', 'Un motor de ingresos.'],
    ...
    free_title: ['Tu sitio web,', 'a nuestra cuenta.'],
    ...
    form_label: 'Contacto',
    form_title: ['Hablemos de', 'resultados.'],
